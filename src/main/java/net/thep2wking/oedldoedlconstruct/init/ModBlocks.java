...
import net.thep2wking.oedldoedlconstruct.api.ModFlowingFluidBlockEffectBase;
...
public class ModBlocks 
{
    ...
    public static final RegistryObject<FlowingFluidBlock> MOLTEN_BASE = BLOCKS.register("molten_base",
            () -> new ModFlowingFluidBlockBase(() -> ModFluids.MOLTEN_BASE_STILL.get(), 15, AbstractBlock.Properties.create(Material.LAVA, MaterialColor.IRON)));
    public static final RegistryObject<FlowingFluidBlock> MOLTEN_MITHRIL = BLOCKS.register("molten_mithril",
            () -> new ModFlowingFluidBlockBase(() -> ModFluids.MOLTEN_MITHRIL_STILL.get(), 15, AbstractBlock.Properties.create(Material.LAVA, MaterialColor.CYAN)));
    ...
    public static final RegistryObject<FlowingFluidBlock> MOLTEN_NAGATORIUM = BLOCKS.register("molten_nagatorium",
            () -> new ModFlowingFluidBlockEffectBase(() -> ModFluids.MOLTEN_NAGATORIUM_STILL.get(), Effects.UNLUCK, true, 15, AbstractBlock.Properties.create(Material.LAVA, MaterialColor.PURPLE)));
	...
	public static void register(IEventBus enevtBus)
	{
		...
		OedldoedlConstruct.LOGGER.info("Registerd Blocks for " + OedldoedlConstruct.MODID + "!");
	}
}