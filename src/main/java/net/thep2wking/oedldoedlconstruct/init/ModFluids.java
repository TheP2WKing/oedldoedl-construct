...
public class ModFluids 
{
    ...
    public static final RegistryObject<ForgeFlowingFluid> MOLTEN_MITHRIL_STILL = FLUIDS.register("molten_mithril_still", 
    		() -> new ForgeFlowingFluid.Source(ModFluids.MITHRIL_PROPERTIES));
    public static final RegistryObject<ForgeFlowingFluid> MOLTEN_MITHRIL_FLOW = FLUIDS.register("molten_mithril_flow", 
    		() -> new ForgeFlowingFluid.Flowing(ModFluids.MITHRIL_PROPERTIES)); 
    ...
    public static final ForgeFlowingFluid.Properties MITHRIL_PROPERTIES = new ForgeFlowingFluid.Properties(
            () -> MOLTEN_MITHRIL_STILL.get(), () -> MOLTEN_MITHRIL_FLOW.get(), ModFluidUtil.moltenFluidBuilder(0xff528db3)).slopeFindDistance(2).levelDecreasePerBlock(2).tickRate(30)
    		.block(() -> ModBlocks.MOLTEN_MITHRIL.get()).bucket(() -> ModItems.MOLTEN_MITHRIL_BUCKET.get());
    ...
    public static void register(IEventBus eventBus) 
    {
		...
		OedldoedlConstruct.LOGGER.info("Registerd Fluids for " + OedldoedlConstruct.MODID + "!");
    }
}