...
public class HimejimariuslyModifier extends Modifier 
{
    public HimejimariuslyModifier() 
    {
        super(0x232033);
    }
    ...
    public int afterEntityHit(IModifierToolStack tool, int level, ToolAttackContext context, float damageDealt) 
    {
        ...
        if (target != null) 
        {
            ...
            {
                Item shard = ForgeRegistries.ITEMS.getValue(new ResourceLocation(OedldoedlResources.MODID, "himejimarium_shard"));
    ...
    public void onInventoryTick(IModifierToolStack tool, int level, World world, LivingEntity holder, int itemSlot, boolean isSelected, boolean isCorrectSlot, ItemStack stack) 
    {
    	...
    	{
    		holder.addPotionEffect(new EffectInstance(Effects.RESISTANCE, 19, ConstructConfig.tinker_tools_base_amplifier.get() - 1, false, false));
    	}
    }
}