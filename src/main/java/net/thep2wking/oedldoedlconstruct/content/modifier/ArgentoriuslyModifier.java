...
public class ArgentoriuslyModifier extends Modifier 
{
    public ArgentoriuslyModifier() 
    {
        super(0xfbd985);
    }
    ...
    public int afterEntityHit(IModifierToolStack tool, int level, ToolAttackContext context, float damageDealt) 
    {
        ...
        if (target != null) 
        {
            ...
            {
                Item shard = ForgeRegistries.ITEMS.getValue(new ResourceLocation(OedldoedlResources.MODID, "argentorium_shard"));
    ...
    public void onInventoryTick(IModifierToolStack tool, int level, World world, LivingEntity holder, int itemSlot, boolean isSelected, boolean isCorrectSlot, ItemStack stack) 
    {
    	...
    	{
    		holder.addPotionEffect(new EffectInstance(Effects.SATURATION, 19, ConstructConfig.tinker_tools_base_amplifier.get() - 1, false, false));
    	}
    }
}