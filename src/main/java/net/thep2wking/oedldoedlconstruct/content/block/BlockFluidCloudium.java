...
public class BlockFluidCloudium extends ModBlockFluidEffectBase {
	public BlockFluidCloudium(String modid, String name, Fluid fluid, Material material, MapColor mapColor,
