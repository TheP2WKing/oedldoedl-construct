...
{ 
	private static final ResourceLocation ID = new ResourceLocation(OedldoedlConstruct.MODID, "enable_mod_recipes");
	...
	public boolean test() 
	{
		return ConstructConfig.enable_mod_recipes.get();
	}
