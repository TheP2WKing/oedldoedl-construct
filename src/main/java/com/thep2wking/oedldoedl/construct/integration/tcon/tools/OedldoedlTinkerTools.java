...
public class OedldoedlTinkerTools 
{
	...
	{
		//material - base
		if (ToolsConst.BASE_TOOLS && ResourcesConfig.RESOURCES.metals.base.enabled)
		{
			base = new Material("oedldoedlconstruct.base", 0x9d9d9d);
			base.addItem(ItemInit.ITEM_BASE_INGOT, 1, Material.VALUE_Ingot);
		...
		//material - bedrockium
		if (ToolsConst.BEDROCKIUM_TOOLS && ResourcesConfig.RESOURCES.metals.bedrockium.enabled)
		{
		...
		//material - sadistium
		if (ToolsConst.SADISTIUM_TOOLS && ResourcesConfig.RESOURCES.metals.sadistium.enabled)
		{
			...
			new HandleMaterialStats(0.01F, StatsConst.SADISTIUM_TOOLS_EXTRA_DURABILITY), new ExtraMaterialStats(StatsConst.SADISTIUM_TOOLS_EXTRA_DURABILITY), new BowMaterialStats(0.01F, 0.01F, 0.01F));
		...
		//material - gremorium
		if (ToolsConst.GREMORIUM_TOOLS && ResourcesConfig.RESOURCES.metals.gremorium.enabled)
		{
		...
		if (ToolsConst.HIMEJIMARIUM_TOOLS && ResourcesConfig.RESOURCES.metals.himejimarium.enabled)
		{
		...
		//material - toujourium
		if (ToolsConst.TOUJOURIUM_TOOLS && ResourcesConfig.RESOURCES.metals.toujourium.enabled)
		{
		...
		if (ToolsConst.ARGENTORIUM_TOOLS && ResourcesConfig.RESOURCES.metals.argentorium.enabled)
		{
		...
		//material - quartarium
		if (ToolsConst.QUARTARIUM_TOOLS && ResourcesConfig.RESOURCES.metals.quartarium.enabled)
		{
		...
		//material - chaos
		if (ToolsConst.CHAOS_TOOLS && ResourcesConfig.RESOURCES.metals.chaos.enabled)
		{
		...
		//material - base
		if (ToolsConst.BASE_TOOLS && FluidsConst.BASE_FLUID && ResourcesConfig.RESOURCES.metals.base.enabled)
		{
			TinkerRegistry.integrate(base, moltenBase, "Base").toolforge().preInit();
		}
		else if (ToolsConst.BASE_TOOLS && ResourcesConfig.RESOURCES.metals.base.enabled)
		{
			TinkerRegistry.integrate(base, "Base").toolforge().preInit();
		}
		
		//material - oedldoedl
		if (FluidsConst.OEDLDOEDL_FLUID && ResourcesConfig.RESOURCES.metals.oedldoedl.enabled)
		{
			TinkerRegistry.integrate(moltenOedldoedl, "Oedldoedl").toolforge().preInit();
		}
		
		//material - bedrockium
		if (ToolsConst.BEDROCKIUM_TOOLS && FluidsConst.BEDROCKIUM_FLUID && ResourcesConfig.RESOURCES.metals.bedrockium.enabled)
		{
			TinkerRegistry.integrate(bedrockium, moltenBedrockium, "Bedrockium").toolforge().preInit();
		}
		else if (ToolsConst.BEDROCKIUM_TOOLS && ResourcesConfig.RESOURCES.metals.bedrockium.enabled)
		{
			TinkerRegistry.integrate(bedrockium, "Bedrockium").toolforge().preInit();
		}
		
		//material - sadistium
		if (ToolsConst.SADISTIUM_TOOLS && FluidsConst.SADISTIUM_FLUID && ResourcesConfig.RESOURCES.metals.sadistium.enabled)
		{
			TinkerRegistry.integrate(sadistium, moltenSadistium, "Sadistium").toolforge().preInit();
		}
		else if (ToolsConst.SADISTIUM_TOOLS && ResourcesConfig.RESOURCES.metals.sadistium.enabled)
		{
			TinkerRegistry.integrate(sadistium, "Sadistium").toolforge().preInit();
		}
		
		//material - gremorium
		if (ToolsConst.GREMORIUM_TOOLS && FluidsConst.GREMORIUM_FLUID && ResourcesConfig.RESOURCES.metals.gremorium.enabled)
		{
			TinkerRegistry.integrate(gremorium, moltenGremorium, "Gremorium").toolforge().preInit();
		}
		else if (ToolsConst.GREMORIUM_TOOLS && ResourcesConfig.RESOURCES.metals.gremorium.enabled)
		{
			TinkerRegistry.integrate(gremorium, "Gremorium").toolforge().preInit();
		}	
		
		//material - himejimarium
		if (ToolsConst.HIMEJIMARIUM_TOOLS && FluidsConst.HIMEJIMARIUM_FLUID && ResourcesConfig.RESOURCES.metals.himejimarium.enabled)
		{
			TinkerRegistry.integrate(himejimarium, moltenHimejimarium, "Himejimarium").toolforge().preInit();
		}
		else if (ToolsConst.HIMEJIMARIUM_TOOLS && ResourcesConfig.RESOURCES.metals.himejimarium.enabled)
		{
			TinkerRegistry.integrate(himejimarium, "Himejimarium").toolforge().preInit();
		}
		
		//material - toujourium
		if (ToolsConst.TOUJOURIUM_TOOLS && FluidsConst.TOUJOURIUM_FLUID && ResourcesConfig.RESOURCES.metals.toujourium.enabled)
		{
			TinkerRegistry.integrate(toujourium, moltenToujourium, "Toujourium").toolforge().preInit();
		}
		else if (ToolsConst.TOUJOURIUM_TOOLS && ResourcesConfig.RESOURCES.metals.toujourium.enabled)
		{
			TinkerRegistry.integrate(toujourium, "Toujourium").toolforge().preInit();
		}
		
		//material - argentorium
		if (ToolsConst.ARGENTORIUM_TOOLS && FluidsConst.ARGENTORIUM_FLUID && ResourcesConfig.RESOURCES.metals.argentorium.enabled)
		{
			TinkerRegistry.integrate(argentorium, moltenArgentorium, "Argentorium").toolforge().preInit();
		}
		else if (ToolsConst.ARGENTORIUM_TOOLS && ResourcesConfig.RESOURCES.metals.argentorium.enabled)
		{
			TinkerRegistry.integrate(argentorium, "Argentorium").toolforge().preInit();
		}
		
		//material - quartarium
		if (ToolsConst.QUARTARIUM_TOOLS && FluidsConst.QUARTARIUM_FLUID && ResourcesConfig.RESOURCES.metals.quartarium.enabled)
		{
			TinkerRegistry.integrate(quartarium, moltenQuartarium, "Quartarium").toolforge().preInit();	
		}
		else if (ToolsConst.QUARTARIUM_TOOLS && ResourcesConfig.RESOURCES.metals.quartarium.enabled)
		{
			TinkerRegistry.integrate(quartarium, "Quartarium").toolforge().preInit();
		}
		
		//material - chaos
		if (ToolsConst.CHAOS_TOOLS && FluidsConst.CHAOS_FLUID && ResourcesConfig.RESOURCES.metals.chaos.enabled)
		{
			TinkerRegistry.integrate(chaos, moltenChaos, "Chaos").toolforge().preInit();
		}
		else if (ToolsConst.CHAOS_TOOLS && ResourcesConfig.RESOURCES.metals.chaos.enabled)
		{
	...
	public static void initTraits() 
	{
		...
		if (ToolsConst.CHAOS_TOOLS && ResourcesConfig.RESOURCES.metals.chaos.enabled)
		{
			...
			if (TraitsConst.HATER_TRAIT)
			{
				chaos.addTrait(TraitHater.getTrait(), MaterialTypes.HEAD);
				chaos.addTrait(TraitHater.getTrait());
			}
		}
	}
	...
	{
		//material - base
		if (FluidsConst.BASE_FLUID && ToolsConst.BASE_TOOLS && ResourcesConfig.RESOURCES.metals.base.enabled)
		{
		...
		//material - sadistium
		if (FluidsConst.SADISTIUM_FLUID && ToolsConst.SADISTIUM_TOOLS && ResourcesConfig.RESOURCES.metals.sadistium.enabled)
		{
			FluidRenderHandler.mapFluidState(moltenSadistium);
		}
		
		//material - bedrockium
		if (FluidsConst.BEDROCKIUM_FLUID && ToolsConst.BEDROCKIUM_TOOLS && ResourcesConfig.RESOURCES.metals.bedrockium.enabled)
		{
			FluidRenderHandler.mapFluidState(moltenBedrockium);
		}
		
		//material - gremorium
		if (FluidsConst.GREMORIUM_FLUID && ToolsConst.GREMORIUM_TOOLS && ResourcesConfig.RESOURCES.metals.gremorium.enabled)
		{
			FluidRenderHandler.mapFluidState(moltenGremorium);
		}
		
		//material - himejimarium
		if (FluidsConst.HIMEJIMARIUM_FLUID && ToolsConst.HIMEJIMARIUM_TOOLS && ResourcesConfig.RESOURCES.metals.himejimarium.enabled)
		{
			FluidRenderHandler.mapFluidState(moltenHimejimarium);
		}
		
		//material - toujourium
		if (FluidsConst.TOUJOURIUM_FLUID && ToolsConst.TOUJOURIUM_TOOLS && ResourcesConfig.RESOURCES.metals.toujourium.enabled)
		{
			FluidRenderHandler.mapFluidState(moltenToujourium);
		}
		
		//material - argentorium
		if (FluidsConst.ARGENTORIUM_FLUID && ToolsConst.ARGENTORIUM_TOOLS && ResourcesConfig.RESOURCES.metals.argentorium.enabled)
		{
			FluidRenderHandler.mapFluidState(moltenArgentorium);
		}
		
		//material - quartarium
		if (FluidsConst.QUARTARIUM_FLUID && ToolsConst.QUARTARIUM_TOOLS && ResourcesConfig.RESOURCES.metals.quartarium.enabled)
		{
			FluidRenderHandler.mapFluidState(moltenQuartarium);
		}
		
		//material - chaos
		if (FluidsConst.CHAOS_FLUID && ToolsConst.CHAOS_TOOLS && ResourcesConfig.RESOURCES.metals.chaos.enabled)
		{
