...
public class ItemSadisticModifier extends Item implements IHasModel
{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced)
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation)
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.sadistic_modifier.tip"),
  				TextFormatting.WHITE+""+TextFormatting.ITALIC+I18n.format("item.oedldoedl.sadistic_modifier.tip2"),
  			});
  		}
	}
}