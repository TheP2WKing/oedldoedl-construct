...
public class ItemInfinityModifier extends Item implements IHasModel
{
	...
	public void func_77624_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced)
	{
  		if (CoreConst.ITEM_INFORMATION)
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.infinity_modifier.tip"),
  				TextFormatting.WHITE+""+TextFormatting.ITALIC+I18n.func_135052_a("item.oedldoedl.infinity_modifier.tip2"),
  			});
  		}
	}
}