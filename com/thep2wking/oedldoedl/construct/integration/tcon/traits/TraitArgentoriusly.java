...
public class TraitArgentoriusly extends AbstractTrait 
{

	private static AbstractTrait argentoriusly = new TraitArgentoriusly();

	public TraitArgentoriusly() 
	{
		super("argentoriusly", 0xfbd985);
	}

	@Override
	public String getLocalizedName() 
	{
		return new TextComponentTranslation("trait.oedldoedlconstruct.argentoriusly.name").func_150254_d();
	}

	@Override
	public String getLocalizedDesc() 
	{
		return new TextComponentTranslation("trait.oedldoedlconstruct.argentoriusly.tip").func_150254_d();
	}
	...
	public void afterHit(ItemStack tool, EntityLivingBase player, EntityLivingBase target, float damageDealt, boolean wasCritical, boolean wasHit) 
	{
		...
		if (!target.func_70089_S() && !world.field_72995_K) 
		{
        	...
        	{  	
        		items.add(drop(target, ItemInit.ITEM_ARGENTORIUM_NUGGET, MathHelper.func_76136_a(rand, 0, 2), MathHelper.func_76136_a(rand, 0, 2), MathHelper.func_76136_a(rand, 0, 2)));
        	}
