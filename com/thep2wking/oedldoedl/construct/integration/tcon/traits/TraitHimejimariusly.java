...
public class TraitHimejimariusly extends AbstractTrait 
{

	private static AbstractTrait himejimariusly = new TraitHimejimariusly();

	public TraitHimejimariusly() 
	{
		super("himejimariusly", 0x232033);
	}

	@Override
	public String getLocalizedName() 
	{
		return new TextComponentTranslation("trait.oedldoedlconstruct.himejimariusly.name").func_150254_d();
	}

	@Override
	public String getLocalizedDesc() 
	{
		return new TextComponentTranslation("trait.oedldoedlconstruct.himejimariusly.tip").func_150254_d();
	}
	...
	public void afterHit(ItemStack tool, EntityLivingBase player, EntityLivingBase target, float damageDealt, boolean wasCritical, boolean wasHit) 
	{
		...
		if (!target.func_70089_S() && !world.field_72995_K) 
		{
        	...
        	{  	
        		items.add(drop(target, ItemInit.ITEM_HIMEJIMARIUM_NUGGET, MathHelper.func_76136_a(rand, 0, 2), MathHelper.func_76136_a(rand, 0, 2), MathHelper.func_76136_a(rand, 0, 2)));
        	}
